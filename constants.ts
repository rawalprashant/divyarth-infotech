...
export const FIGMA_LINK = 'https://www.figma.com/community/file/935959613109017886/Chakra-Templates-UI-Kit';
export const CONTRIBUTORS_LINK = 'https://github.com/hauptrolle/chakra-templates/graphs/contributors';
export const CONTRIBUTE_LINK = 'https://github.com/hauptrolle/chakra-templates/blob/main/CONTRIBUTING.md';
export const SUGGEST_TEMPLATE_LINK = 'https://github.com/hauptrolle/chakra-templates/issues/new?assignees=&labels=&template=template_request.md';
...
export const SEO_DESCRIPTION = 'A growing open-source collection of hand-crafted Chakra UI templates ready to drop into your React project.';
export const SEO_KEYWORDS = 'chakra ui, ui templates, web templates, web design, react templates, react ui templates, chakra ui templates, chakra templates';
